...
- Tracing every single import or dependency
- Reading generated, vendored, or test files (unless asked)
- Performing root cause analysis of bugs
- Evaluating security or performance implications

## Response Shaping

**Default (Concise)**: Core findings with key file:line references
**Detailed**: Include code examples and step-by-step data flow
**Max results**: 50 findings (circuit breaker)
