...
| `df:planning`    | A new file exists under `thoughts/plans/`, its `## Execution Schedule` lists every phase exactly once, and the new plan opens with a frontmatter block whose `status` is `draft`                                                                                                                                                                                                                                    |
