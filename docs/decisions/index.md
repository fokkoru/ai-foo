...
- [0012 A bilingual prompt answers in plain Markdown](0012-a-bilingual-prompt-answers-in-plain-markdown.md) - The text-editor GPT returns its two language versions as plain Markdown separated by a horizontal rule, and asks the interface for nothing.
